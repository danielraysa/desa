...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                <img src="{{ asset('assets/img/logo.png') }}" style="width: 20px" alt="">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Ndesoo</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="{{ url('/statistik') }}">Statistik</a>
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="{{ url('/pengaduan') }}">Pengaduan</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <footer class="bg-light py-5">
            <div class="container"><h6 class="small text-center text-muted">2020 - Ndesoo</h6></div>
        </footer>
        <!-- Bootstrap core JS-->
