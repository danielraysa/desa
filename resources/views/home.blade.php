                  ...
                  <div class="col-lg-4 col-12 my-2">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <a href="{{ url('/skck') }}" class="btn btn-primary">Buat Surat</a>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-4 col-12 my-2">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <a href="{{ url('/tidak-mampu')}}" class="btn btn-primary">Buat Surat</a>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-4 col-12 my-2">
                    <div class="card">
                      <div class="card-body">
                        ...
                        <a href="{{ url('/izin-keramaian')}}" class="btn btn-primary">Buat Surat</a>
                      </div>
                    </div>
                  </div>
                </div>
                <a class="btn btn-light btn-xl js-scroll-trigger" href="{{ url('/surat') }}">Lihat Lebih Banyak</a>
            </div>
        </div>
    </div>
</section>
